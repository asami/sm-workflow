# Historical Phase 1 Design: Pre-Reconciliation Operational Scope

Status: historical / deferred; not a Phase 1 closure authority

This file preserves the complete pre-reconciliation Phase 1 design together
with the scope-reconciliation edits that were applied before the normative
Phase definition was shortened. It is retained as design input for later
connectivity and operational-hardening Phases.

The current normative Phase is [Phase 1](../phase/phase-1.md), and its sole
closure authority is the
[Phase 1 Executable-Specification Checklist](../phase/phase-1-executable-specification-checklist.md).
Nothing in this historical record enlarges the current Phase 1 boundary.
...
Checklist: [Phase 1 Executable-Specification Checklist](../phase/phase-1-executable-specification-checklist.md)
...
[Phase 1 Executable-Specification Checklist](../phase/phase-1-executable-specification-checklist.md).
The prior [Phase 1 checklist](../phase/phase-1-checklist.md) remains an immutable
...
The 2026-09-20
[scope reconciliation decision](../journal/2026/09/2026-09-20-phase-1-common-contract-scope-reconciliation.md)
...
The pre-reconciliation proposal required every item in the historical
[phase-1-checklist.md](../phase/phase-1-checklist.md), all A1–A7 acceptance
groups, and final-tree-bound evidence. This rule is preserved here only as
historical context and is not a current Phase 1 closure condition.
